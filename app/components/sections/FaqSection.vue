<template>
    <section class="max-w-2xl mx-auto py-12">
        <h2 class="text-center text-2xl font-bold mb-8">Yang sering ditanyakan</h2>
...
.faq-slide-leave-active {
    transition: max-height 280ms cubic-bezier(.2,.8,.2,1), opacity 200ms ease, transform 200ms ease;
}
.faq-slide-leave-to {
    max-height: 0;
    opacity: 0;
